package trabajo1.model;
    ...
    import trabajo1.model.subnivel.Control;
    import trabajo1.model.subnivel.Utilidades;
    import trabajo1.model.subnivel.under.InternalSys;
...
public class LoggerChinpokomon {
    ...
    // maneje
    private final static Logger LOG_RAIZ = Logger.getLogger("trabajo1.model");
    private final static Logger LOG_SUBNIVEL = Logger.getLogger("trabajo1.model.subnivel");
    private final static Logger LOG_UNDER = Logger.getLogger("trabajo1.model.subnivel.under");

    // El log para ESTA clase en particular
    private final static Logger LOGGER = Logger.getLogger("trabajo1.model.Logger");
    ...
    public static void main(String[] args) {
        try {
            ...
            try {
                ...
                LOGGER.log(Level.SEVERE, LoggerChinpokomon.getStackTrace(e));
            }
